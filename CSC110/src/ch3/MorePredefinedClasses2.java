...
public class MorePredefinedClasses2 {
	...
	public static void main(String[] args) {
		...
		DecimalFormat dFmt3 = new DecimalFormat("0.###");
		...
		System.out.println("the value of PI (formatted): " + dFmt3.format(Math.PI));
		...
		price = 43.239;
		System.out.println("The price in currency format is: " + cFmt.format(price));
